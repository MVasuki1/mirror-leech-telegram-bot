...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
       ...
       --rpc-max-request-size=1024M --rpc-listen-all=true --rpc-listen-port=6800 --max-connection-per-server=10 \
       --max-concurrent-downloads=10 --split=10 \
       --seed-time=0 --check-integrity=true --continue=true --daemon=true --disk-cache=40M --force-save=true \
